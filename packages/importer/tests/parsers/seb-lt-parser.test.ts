...
`;
      ...
      expect(result.transactions[0].externalId).toBe("TM001");
      expect(result.transactions[1].externalId).toBe("TM002");
      expect(result.transactions[2].externalId).toBe("TM003");
    });
